...
-- =============================================================================
-- BEGIN: 015_facturacion.sql — tarifario por provincia + datos de facturación
-- (emisor/receptor + IVA) para generar la factura desde el reporte.
-- =============================================================================
